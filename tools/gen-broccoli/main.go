...
import (
	...
	"github.com/elvisNg/broccoliv2/tools/gen-broccoli/generator"
)
...
func main() {
	...
	isOnlyErr := flag.Bool("onlyerr", false, "gen-broccoli -onlyerr -errdef=proto/errdef.proto")

	flag.Parse()
	var err error
	var reader *os.File
	if !*isbroccolierr && !*isOnlyErr {
