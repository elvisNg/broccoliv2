...
func GeneratebroccoliErrdef(PD *Generator, rootdir string) (err error) {
	err = genbroccoliErrdef(PD, rootdir)
	if err != nil {
		return err
	}
	return
...
func genbroccoliErrdef(PD *Generator, rootdir string) error {
...
`
	...
	fn := GetTargetFileName(PD, "broccoli.errdef", rootdir)
