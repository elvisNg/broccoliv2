...
import (
	...
	"github.com/elvisNg/broccoliv2/pprof"
	...
	"github.com/elvisNg/broccoliv2/engine/etcd"
	"github.com/elvisNg/broccoliv2/engine/file"
	broccolierrors "github.com/elvisNg/broccoliv2/errors"
	zgomicro "github.com/elvisNg/broccoliv2/microsrv/gomicro"
	"github.com/elvisNg/broccoliv2/plugin/zcontainer"
	swagger "github.com/elvisNg/broccoliv2/swagger/ui"
...
func (s *Service) newGomicroSrv(conf config.GoMicro, srvopts ...micro.Option) (gms micro.Service, err error) {
	...
	if err != nil {
		log.Println("[broccoli] [s.newGomicroSrv] zgomicro.NewClient err:", err)
		return
	}
	// 把client设置到container
...
func (s *Service) newHTTPGateway(opt gwOption) (h http.Handler, err error) {
	...
	log.Println("[broccoli] [s.newHTTPGateway] servePrometheus success.")
	// http handler
